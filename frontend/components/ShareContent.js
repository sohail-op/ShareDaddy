...
const ShareContent = () => {
  ...
  return (
    <div className="w-1/2 bg-[#F5F1ED] p-12">
      <header className=" text-black -mt-10 pb-8 ">
        <a href="" className="font-rochester text-4xl">
        ShareDaddy
        </a>
      <p className="text-[#2E2E2E]/90 text-base font-sans">
        Daddy of Sharing
      </p>
      </header>
      <div className="max-w-xl mx-auto space-y-8">
        <div className="text-[#2E2E2E]/90 flex flex-row gap-2 items-center">
          <h2 className="text-xl font-medium text-[#2E2E2E]/90">
            Share Content
          </h2>
          <textarea
            placeholder="Code"
